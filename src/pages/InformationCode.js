...
const InformationCode = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      try {
        const response = await axiosInstance.get('https://2ecb-2406-5900-10f0-c886-1c07-11ef-e410-ee21.ngrok-free.app/api/board/coding', {
    ...
    const fetchTopLikedPosts = async () => {
      try {
        const response = await axiosInstance.get('https://2ecb-2406-5900-10f0-c886-1c07-11ef-e410-ee21.ngrok-free.app/api/board/coding/top-liked', {
          headers: {
            'ngrok-skip-browser-warning': 'true', // 경고 페이지를 우회하는 헤더 추가
          },
        });
  ...
  const handleSort = async (type) => {
    ...
    try {
      ...
      const response = await axiosInstance.get('https://2ecb-2406-5900-10f0-c886-1c07-11ef-e410-ee21.ngrok-free.app/api/board/coding/sort-by-likes', {
        params,
        headers: {
